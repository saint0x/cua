...
fn main() {
    ...
    println!("cargo::rustc-check-cfg=cfg(gpui_runtime_shaders_fallback)");
...
mod macos {
    ...
    pub(super) fn build() {
        ...
        #[cfg(not(feature = "macos-blade"))]
        {
            ...
            compile_metal_shaders_or_enable_runtime_fallback(&header_path);
        }
    }
    ...
    #[cfg(not(feature = "runtime_shaders"))]
    fn compile_metal_shaders_or_enable_runtime_fallback(header_path: &Path) {
