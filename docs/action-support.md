...
| macOS | CoreGraphics display capture | CGEvent mouse and keyboard | Native still-frame capture, input dispatch, and permission probes wired | Local daemon smoke and unit tests |
