...
CUA_VOICE_LOCAL_PLANNER_SCENARIO=failed-action-repair scripts/host-voice-local-planner-loop-proof.sh
CUA_VOICE_LOCAL_PLANNER_SCENARIO=repeated-rejected-plan scripts/host-voice-local-planner-loop-proof.sh
...
fozzy test --det --strict-verify fozzy/scenarios/cua-rlm-loop-depth.fozzy.json --json
fozzy run fozzy/scenarios/cua-rlm-loop-depth.fozzy.json --det --record artifacts/cua/fozzy/cua-rlm-loop-depth.fozzy --json
fozzy trace verify artifacts/cua/fozzy/cua-rlm-loop-depth.fozzy --strict --json
...
fozzy run fozzy/scenarios/cua-rlm-loop-local-planner-host.fozzy.json --det --host-backends --record artifacts/cua/fozzy/cua-rlm-loop-local-planner-host.fozzy --json
fozzy trace verify artifacts/cua/fozzy/cua-rlm-loop-local-planner-host.fozzy --strict --json
fozzy replay artifacts/cua/fozzy/cua-rlm-loop-local-planner-host.fozzy --json
fozzy ci artifacts/cua/fozzy/cua-rlm-loop-local-planner-host.fozzy --strict --json
```
...
The voice proof suite runs non-visual loop and provider checks by default. Set
`CUA_VOICE_PROOF_SUITE_INCLUDE_UI=1` when you want the headful HUD screenshot
proof included in the same suite.
